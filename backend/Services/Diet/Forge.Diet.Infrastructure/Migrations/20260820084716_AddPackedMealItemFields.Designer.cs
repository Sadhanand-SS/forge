...
namespace Forge.Diet.Infrastructure.Migrations
{
    ...
    [Migration("20260820084716_AddPackedMealItemFields")]
    partial class AddPackedMealItemFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Forge.Diet.Domain.Entities.DailyMealMealItem", b =>
                {
                    ...
                    b.Property<decimal?>("TotalCookedWeight")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");
            ...
            modelBuilder.Entity("Forge.Diet.Domain.Entities.DailyMealMealItemIngredient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("DailyMealMealItemId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DailyMealMealItemId");

                    b.HasIndex("IngredientId");

                    b.HasIndex("UnitId");

                    b.ToTable("DailyMealMealItemIngredients", (string)null);
                });
            ...
            modelBuilder.Entity("Forge.Diet.Domain.Entities.DailyMealMealItemIngredient", b =>
                {
                    b.HasOne("Forge.Diet.Domain.Entities.DailyMealMealItem", "DailyMealMealItem")
                        .WithMany("Ingredients")
                        .HasForeignKey("DailyMealMealItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("DailyMealMealItem");
